      ...
      child: SingleChildScrollView(
        child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                const Text('DRAW WINNING NUMBER', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w500),),
                const SizedBox(height: 10),
                Row(
                  children: <Widget>[
                    const Text('Draw ', style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w500),),
